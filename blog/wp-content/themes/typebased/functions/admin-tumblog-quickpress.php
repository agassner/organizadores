...
<div id="tumblog-post">
	...
	<div id="video-fields" class="hide-fields">
		...
		<textarea style="width:100%" id="video-embed" name="video-embed"></textarea>
	</div>
	...
	<div id="image-fields" class="hide-fields">
		...
		<div id="image-option-upload" style="display:none;">
			...
			<div>
				<input name="image-upload" id="image-upload" tabindex="1" autocomplete="off" value="" type="text">
			</div>
		...
		<div id="image-option-url">
			...
			<div>
				<input name="image-url" id="image-url" tabindex="1" autocomplete="off" value="" type="text">
			</div>
		</div>
	...
	<div id="link-fields" class="hide-fields">
		...
		<div>
			<input name="link-url" id="link-url" tabindex="1" autocomplete="off" value="" type="text">
		</div>
	</div>
	...
	<div id="quote-fields" class="hide-fields">
		...
		<textarea style="width:100%" id="quote-copy" name="quote-copy"></textarea>
		<h4 id="quick-post-title"><label for="quote-url">Quote URL</label></h4>
		<div>
			<input name="quote-url" id="quote-url" tabindex="1" autocomplete="off" value="" type="text">
		</div>
		<h4 id="quick-post-title"><label for="quote-quote">Quote Author</label></h4>
		<div>
			<input name="quote-author" id="quote-author" tabindex="1" autocomplete="off" value="" type="text">
		</div>
	</div>
	...
	<div id="audio-fields" class="hide-fields">
		...
		<div id="audio-option-upload" style="display:none;">
			...
			<div>
				<input name="audio-upload" id="audio-upload" tabindex="1" autocomplete="off" value="" type="text">
			</div>
		...
		<div id="audio-option-url">
			...
			<div>
				<input name="audio-url" id="audio-url" tabindex="1" autocomplete="off" value="" type="text">
			</div>
		</div>
	...
	<div id="content-fields" class="hide-fields">
		<?php if ( current_user_can( 'upload_files' ) ) : ?>
			<?php the_editor('', $id = 'content', $prev_id = 'title', $media_buttons = false, $tab_index = 1); ?>
		<?php endif; ?>
	...
	<div id="tumblog-submit-fields" class="hide-fields">
		<input name="tumblogsubmit" type="submit" id="tumblogsubmit" class="button-primary" tabindex="3" value="Submit" onclick="return validateInput();" />
		<input name="tumblogreset" type="reset" id="tumblogreset" class="button" tabindex="3" value="Reset" />
	</div>
